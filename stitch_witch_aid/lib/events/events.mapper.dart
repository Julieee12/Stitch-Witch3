...
class BaseEventMapper extends ClassMapperBase<BaseEvent> {
  ...
  static BaseEventMapper ensureInitialized() {
    if (_instance == null) {
      ...
      ClientSendsCoordinatesEventMapper.ensureInitialized();
      ServerSendsCoordsEventMapper.ensureInitialized();
...
class ClientSendsCoordinatesEventMapper
    extends SubClassMapperBase<ClientSendsCoordinatesEvent> {
  ClientSendsCoordinatesEventMapper._();

  static ClientSendsCoordinatesEventMapper? _instance;
  static ClientSendsCoordinatesEventMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = ClientSendsCoordinatesEventMapper._());
  ...
  @override
  final String id = 'ClientSendsCoordinatesEvent';

  static String _$eventType(ClientSendsCoordinatesEvent v) => v.eventType;
  static const Field<ClientSendsCoordinatesEvent, String> _f$eventType =
      Field('eventType', _$eventType);
  static String _$requestId(ClientSendsCoordinatesEvent v) => v.requestId;
  static const Field<ClientSendsCoordinatesEvent, String> _f$requestId =
      Field('requestId', _$requestId);
  static CoordinatesModel _$coordinates(ClientSendsCoordinatesEvent v) =>
      v.coordinates;
  static const Field<ClientSendsCoordinatesEvent, CoordinatesModel>
      _f$coordinates = Field('coordinates', _$coordinates);

  @override
  final MappableFields<ClientSendsCoordinatesEvent> fields = const {
    #eventType: _f$eventType,
    #requestId: _f$requestId,
  ...
  @override
  final dynamic discriminatorValue = ClientSendsCoordinatesEvent.name;
  @override
  late final ClassMapperBase superMapper = BaseEventMapper.ensureInitialized();

  static ClientSendsCoordinatesEvent _instantiate(DecodingData data) {
    return ClientSendsCoordinatesEvent(
  ...
  static ClientSendsCoordinatesEvent fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<ClientSendsCoordinatesEvent>(map);
  }

  static ClientSendsCoordinatesEvent fromJson(String json) {
    return ensureInitialized().decodeJson<ClientSendsCoordinatesEvent>(json);
  }
}

mixin ClientSendsCoordinatesEventMappable {
  String toJson() {
    return ClientSendsCoordinatesEventMapper.ensureInitialized()
        .encodeJson<ClientSendsCoordinatesEvent>(
            this as ClientSendsCoordinatesEvent);
  }

  Map<String, dynamic> toMap() {
    return ClientSendsCoordinatesEventMapper.ensureInitialized()
        .encodeMap<ClientSendsCoordinatesEvent>(
            this as ClientSendsCoordinatesEvent);
  }

  ClientSendsCoordinatesEventCopyWith<ClientSendsCoordinatesEvent,
          ClientSendsCoordinatesEvent, ClientSendsCoordinatesEvent>
      get copyWith => _ClientSendsCoordinatesEventCopyWithImpl<
              ClientSendsCoordinatesEvent, ClientSendsCoordinatesEvent>(
          this as ClientSendsCoordinatesEvent, $identity, $identity);
  @override
  String toString() {
    return ClientSendsCoordinatesEventMapper.ensureInitialized()
        .stringifyValue(this as ClientSendsCoordinatesEvent);
  }

  @override
  bool operator ==(Object other) {
    return ClientSendsCoordinatesEventMapper.ensureInitialized()
        .equalsValue(this as ClientSendsCoordinatesEvent, other);
  }

  @override
  int get hashCode {
    return ClientSendsCoordinatesEventMapper.ensureInitialized()
        .hashValue(this as ClientSendsCoordinatesEvent);
  }
}

extension ClientSendsCoordinatesEventValueCopy<$R, $Out>
    on ObjectCopyWith<$R, ClientSendsCoordinatesEvent, $Out> {
  ClientSendsCoordinatesEventCopyWith<$R, ClientSendsCoordinatesEvent, $Out>
      get $asClientSendsCoordinatesEvent => $base.as((v, t, t2) =>
          _ClientSendsCoordinatesEventCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class ClientSendsCoordinatesEventCopyWith<
    $R,
    $In extends ClientSendsCoordinatesEvent,
    $Out> implements BaseEventCopyWith<$R, $In, $Out> {
  CoordinatesModelCopyWith<$R, CoordinatesModel, CoordinatesModel>
      get coordinates;
  @override
  $R call(
      {String? eventType, String? requestId, CoordinatesModel? coordinates});
  ClientSendsCoordinatesEventCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
      Then<$Out2, $R2> t);
}

class _ClientSendsCoordinatesEventCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, ClientSendsCoordinatesEvent, $Out>
    implements
        ClientSendsCoordinatesEventCopyWith<$R, ClientSendsCoordinatesEvent,
            $Out> {
  _ClientSendsCoordinatesEventCopyWithImpl(
      super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<ClientSendsCoordinatesEvent> $mapper =
      ClientSendsCoordinatesEventMapper.ensureInitialized();
  @override
  CoordinatesModelCopyWith<$R, CoordinatesModel, CoordinatesModel>
      get coordinates =>
  ...
  @override
  ClientSendsCoordinatesEvent $make(CopyWithData data) =>
      ClientSendsCoordinatesEvent(
  ...
  @override
  ClientSendsCoordinatesEventCopyWith<$R2, ClientSendsCoordinatesEvent, $Out2>
      $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
          _ClientSendsCoordinatesEventCopyWithImpl<$R2, $Out2>(
              $value, $cast, t);
}

class ServerSendsCoordsEventMapper
    extends SubClassMapperBase<ServerSendsCoordsEvent> {
  ServerSendsCoordsEventMapper._();

  static ServerSendsCoordsEventMapper? _instance;
  static ServerSendsCoordsEventMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(_instance = ServerSendsCoordsEventMapper._());
      BaseEventMapper.ensureInitialized().addSubMapper(_instance!);
    }
    return _instance!;
  }
  ...
  @override
  final String id = 'ServerSendsCoordsEvent';

  static String _$eventType(ServerSendsCoordsEvent v) => v.eventType;
  static const Field<ServerSendsCoordsEvent, String> _f$eventType =
      Field('eventType', _$eventType);
  static String _$requestId(ServerSendsCoordsEvent v) => v.requestId;
  static const Field<ServerSendsCoordsEvent, String> _f$requestId =
      Field('requestId', _$requestId);
  static List<CoordinatesModel> _$coordinates(ServerSendsCoordsEvent v) =>
      v.coordinates;
  static dynamic _arg$coordinates(f) => f<List<CoordinatesModel>>();
  static const Field<ServerSendsCoordsEvent, dynamic> _f$coordinates =
      Field('coordinates', _$coordinates, arg: _arg$coordinates);
  static const Field<ServerSendsCoordsEvent, dynamic> _f$latestCoord =
      Field('latestCoord', null, mode: FieldMode.param);
  static bool _$stitchCounted(ServerSendsCoordsEvent v) => v.stitchCounted;
  static dynamic _arg$stitchCounted(f) => f<bool>();
  static const Field<ServerSendsCoordsEvent, dynamic> _f$stitchCounted =
      Field('stitchCounted', _$stitchCounted, arg: _arg$stitchCounted);
  static CoordinatesModel _$latestCoords(ServerSendsCoordsEvent v) =>
      v.latestCoords;
  static const Field<ServerSendsCoordsEvent, CoordinatesModel> _f$latestCoords =
      Field('latestCoords', _$latestCoords, mode: FieldMode.member);

  @override
  final MappableFields<ServerSendsCoordsEvent> fields = const {
    #eventType: _f$eventType,
    #requestId: _f$requestId,
    #coordinates: _f$coordinates,
    #latestCoord: _f$latestCoord,
    #stitchCounted: _f$stitchCounted,
    #latestCoords: _f$latestCoords,
  };

  @override
  final String discriminatorKey = 'eventType';
  @override
  final dynamic discriminatorValue = ServerSendsCoordsEvent.name;
  @override
  late final ClassMapperBase superMapper = BaseEventMapper.ensureInitialized();

  static ServerSendsCoordsEvent _instantiate(DecodingData data) {
    return ServerSendsCoordsEvent(
        eventType: data.dec(_f$eventType),
        requestId: data.dec(_f$requestId),
        coordinates: data.dec(_f$coordinates),
        latestCoord: data.dec(_f$latestCoord),
        stitchCounted: data.dec(_f$stitchCounted));
  }

  @override
  final Function instantiate = _instantiate;

  static ServerSendsCoordsEvent fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<ServerSendsCoordsEvent>(map);
  }

  static ServerSendsCoordsEvent fromJson(String json) {
    return ensureInitialized().decodeJson<ServerSendsCoordsEvent>(json);
  }
}

mixin ServerSendsCoordsEventMappable {
  String toJson() {
    return ServerSendsCoordsEventMapper.ensureInitialized()
        .encodeJson<ServerSendsCoordsEvent>(this as ServerSendsCoordsEvent);
  }

  Map<String, dynamic> toMap() {
    return ServerSendsCoordsEventMapper.ensureInitialized()
        .encodeMap<ServerSendsCoordsEvent>(this as ServerSendsCoordsEvent);
  }

  ServerSendsCoordsEventCopyWith<ServerSendsCoordsEvent, ServerSendsCoordsEvent,
          ServerSendsCoordsEvent>
      get copyWith => _ServerSendsCoordsEventCopyWithImpl<
              ServerSendsCoordsEvent, ServerSendsCoordsEvent>(
          this as ServerSendsCoordsEvent, $identity, $identity);
  @override
  String toString() {
    return ServerSendsCoordsEventMapper.ensureInitialized()
        .stringifyValue(this as ServerSendsCoordsEvent);
  }

  @override
  bool operator ==(Object other) {
    return ServerSendsCoordsEventMapper.ensureInitialized()
        .equalsValue(this as ServerSendsCoordsEvent, other);
  }

  @override
  int get hashCode {
    return ServerSendsCoordsEventMapper.ensureInitialized()
        .hashValue(this as ServerSendsCoordsEvent);
  }
}

extension ServerSendsCoordsEventValueCopy<$R, $Out>
    on ObjectCopyWith<$R, ServerSendsCoordsEvent, $Out> {
  ServerSendsCoordsEventCopyWith<$R, ServerSendsCoordsEvent, $Out>
      get $asServerSendsCoordsEvent => $base.as((v, t, t2) =>
          _ServerSendsCoordsEventCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class ServerSendsCoordsEventCopyWith<
    $R,
    $In extends ServerSendsCoordsEvent,
    $Out> implements BaseEventCopyWith<$R, $In, $Out> {
  @override
  $R call(
      {String? eventType,
      ...
      dynamic coordinates,
      dynamic latestCoord,
      dynamic stitchCounted});
  ServerSendsCoordsEventCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
      Then<$Out2, $R2> t);
}

class _ServerSendsCoordsEventCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, ServerSendsCoordsEvent, $Out>
    implements
        ServerSendsCoordsEventCopyWith<$R, ServerSendsCoordsEvent, $Out> {
  _ServerSendsCoordsEventCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<ServerSendsCoordsEvent> $mapper =
      ServerSendsCoordsEventMapper.ensureInitialized();
  @override
  $R call(
          {String? eventType,
          ...
          dynamic latestCoord,
          Object? stitchCounted = $none}) =>
      $apply(FieldCopyWithData({
        if (eventType != null) #eventType: eventType,
        if (requestId != null) #requestId: requestId,
        if (coordinates != $none) #coordinates: coordinates,
        #latestCoord: latestCoord,
        if (stitchCounted != $none) #stitchCounted: stitchCounted
      }));
  @override
  ServerSendsCoordsEvent $make(CopyWithData data) => ServerSendsCoordsEvent(
      eventType: data.get(#eventType, or: $value.eventType),
      requestId: data.get(#requestId, or: $value.requestId),
      coordinates: data.get(#coordinates, or: $value.coordinates),
      latestCoord: data.get(#latestCoord),
      stitchCounted: data.get(#stitchCounted, or: $value.stitchCounted));

  @override
  ServerSendsCoordsEventCopyWith<$R2, ServerSendsCoordsEvent, $Out2>
      $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
          _ServerSendsCoordsEventCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
