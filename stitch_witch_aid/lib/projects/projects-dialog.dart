...
class ProjectsDialog extends StatefulWidget {
  ...
  @override
  State<ProjectsDialog> createState() => _AddItemDialogState();
}

class _AddItemDialogState extends State<ProjectsDialog> {
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      // Create the new item
                      final newItem = CreateNewProjectDto(
                        name: _name,
                      ...
                      BlocProvider.of<ProjectBloc>(context).clientCreatesNewProject(newItem);
